                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="{{route('Testimonials.create')}}" class="btn btn-out waves-effect waves-light btn-inverse btn-square">Create</a>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>{{$d->name}}</td>
                                                            <td>{{$d->designation}}</td>
                                                            <td><img src="{{ asset('/Backend/images/testimonials/'.$d->image) }}" alt="Image" title="Image" width="150px" height="200px"></td>
                                                            <td> 
                                                            <form action="{{route('Testimonials.destroy',$d->id)}}" method="Post">
                                                                <a class="btn btn-primary" href="{{route('Testimonials.edit',$d->id)}}">Edit</a>
                                                                @csrf
                                                                @method('DELETE')
