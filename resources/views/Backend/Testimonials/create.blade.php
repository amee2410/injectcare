@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Testimonials"=>"Testimonials", "#"=>"Create"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Testimonials.store')}}" method="POST" enctype="multipart/form-data" >
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <textarea rows="4" cols="50" type="text" class="form-control" name="description" id="p_name" placeholder="description" required></textarea>
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
