@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Testimonials"=>"Testimonials"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Testimonials.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                                @method('PUT') 
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="name" placeholder="Title" value="{{$data->name}}">
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="designation" placeholder="Sub-Title" value="{{$data->designation}}">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <textarea rows="4" cols="50" type="text" class="form-control" name="description" id="p_name" placeholder="description">{{$data->description}}</textarea>
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Image <h6 style="font-size: 14px; color: red;">Size: (170 X 254px)</h6></label>
                                                   <div class="col-sm-10">
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                        <img class="img-fluid card-img-top" style="height: 200px; width: 150px;" src="{{ asset('Backend/images/testimonials/'.$data->image) }}" alt="Card image cap"><br><br>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Alt Tag</label>
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="alt_tag" placeholder="alt tag" value="{{$data->alt_tag}}">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
