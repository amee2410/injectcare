@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Services"=>"Services", "#"=>"Create"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Services.store')}}" method="POST" enctype="multipart/form-data" >
                                                @csrf
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Service Name</label>
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="service_name" id="name" placeholder="Title" required>
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                    <textarea rows="3" cols="50" type="text" name="short_description" class="form-control" placeholder="Enter Description"></textarea>
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
