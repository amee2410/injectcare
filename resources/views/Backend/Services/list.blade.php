                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="{{route('Services.create')}}" class="btn btn-out waves-effect waves-light btn-inverse btn-square">Create</a>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><img src="{{ asset('/Backend/images/Services/'.$d->image) }}" alt="Image" title="Image" width="300px" height="250px"></td>
                                                            <td> 
                                                            <form action="{{route('Services.destroy',$d->id)}}" method="Post">
                                                                <a class="btn btn-primary" href="{{route('Services.edit',$d->id)}}">Edit</a>
                                                                @csrf
                                                                @method('DELETE')
