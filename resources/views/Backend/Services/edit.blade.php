                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Services.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                                @method('PUT') 
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="service_name" id="name" placeholder="Service Name" value="{{$data->service_name}}">
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                    <textarea rows="3" cols="50" type="text" name="short_description" class="form-control" placeholder="Enter Short Description">{{$data->short_description}}</textarea>
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Icon Image <h6 style="font-size: 14px; color: red;">Size: (370 X 283px)</h6></label>
                                                   <div class="col-sm-10">
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <img class="img-fluid card-img-top" style="height: 100px; width: 100px;" src="{{ asset('Backend/images/services/icon/'.$data->icon) }}" alt="Card image cap"><br><br>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label"></label>
                                                   <div class="col-sm-10">
                                                      <img class="img-fluid card-img-top" style="height: 300px; width: 500px;" src="{{ asset('Backend/images/services/'.$data->image) }}" alt="Card image cap"><br><br>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label"></label>
                                                   <div class="col-sm-10">
                                                       <img class="img-fluid card-img-top" style="height: 400px; width: 600px;" src="{{ asset('Backend/images/services/detail/'.$data->detail_image) }}" alt="Card image cap"><br><br>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label"></label>
                                                   <div class="col-sm-10">
                                                       <img class="img-fluid card-img-top" style="height: 300px; width: 1200px;" src="{{ asset('Backend/images/services/banner/'.$data->banner_image) }}" alt="Card image cap"></center><br><br>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Banner Image Alt Tag</label>
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="b_alt_tag" id="name" placeholder="Banner Image Alt Tag" value="{{$data->b_alt_tag}}">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
