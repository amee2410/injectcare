@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Portfolio"=>"Portfolio"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="{{route('Portfolio.create')}}" class="btn btn-out waves-effect waves-light btn-inverse btn-square">Create</a>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            @foreach($data as $d)
                                                            <td>{{$d->id}}</td>
                                                            <td><img src="{{ asset('/Backend/images/portfolio/'.$d->image) }}" alt="Image" title="Image" width="400px" height="200px"></td>
                                                            <td> 
                                                            <form action="{{route('Portfolio.destroy',$d->id)}}" method="Post">
                                                                <a class="btn btn-primary" href="{{route('Portfolio.edit',$d->id)}}">Edit</a>
                                                                @csrf
                                                                @method('DELETE')
