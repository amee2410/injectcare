                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Portfolio.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                                @method('PUT') 
                                                @csrf
                                                ...
                                                <center><img class="img-fluid card-img-top" style="height: 400px; width: 600px;" src="{{ asset('Backend/images/portfolio/'.$data->image) }}" alt="Card image cap"></center><br><br>
