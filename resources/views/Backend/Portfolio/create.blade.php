@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Portfolio"=>"Portfolio", "#"=>"Create"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Portfolio.store')}}" method="POST" enctype="multipart/form-data" >
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      ...
                                                      <option value="{{$s->cat_name}}">{{$s->cat_name}}</option>
                                                      @endforeach
                                                      </select>
                                                   </div>
                                                </div>
