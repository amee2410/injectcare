@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Solutions"=>"Solutions"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Solutions.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                                @method('PUT') 
                                                @csrf

                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Solution Name</label>
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="solution_name" id="name" placeholder="Title" value="{{$data->solution_name}}">
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Image <h6 style="font-size: 14px; color: red;">Size: (650 X 530px)</h6></label>
                                                   <div class="col-sm-10">
                                                      <input type="file" class="form-control" name="image" id="p_img">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                                <center><img class="img-fluid card-img-top" style="height: 400px; width: 600px;" src="{{ asset('Backend/images/solution/'.$data->image) }}" alt="Card image cap"></center><br><br>
