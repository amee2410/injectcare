                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="{{route('Solutions.create')}}" class="btn btn-out waves-effect waves-light btn-inverse btn-square">Create</a>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><img src="{{ asset('/Backend/images/solution/'.$d->image) }}" alt="Image" title="Image" width="300px" height="250px"></td>
                                                            <td> 
                                                            <form action="{{route('Solutions.destroy',$d->id)}}" method="Post">
                                                                <a class="btn btn-primary" href="{{route('Solutions.edit',$d->id)}}">Edit</a>
                                                                @csrf
                                                                @method('DELETE')
