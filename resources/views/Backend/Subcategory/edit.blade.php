@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Subcategory"=>"Subcategory"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Subcategory.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                                @method('PUT') 
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="subcat_name" id="name" placeholder="Title" value="{{$data->subcat_name}}">
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Image 1 <h6 style="font-size: 14px; color: red;">Size: (600 X 800)</h6></label>
                                                   <div class="col-sm-10">
                                                      <input type="file" class="form-control" name="subcat_image" id="p_img">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                               <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                     <img class="img-fluid card-img-top" style="height: 400px; width: 600px;" src="{{ asset('Backend/images/solution/'.$data->subcat_image) }}" alt="Card image cap"><br><br>
                                                   </div>
                                               </div>
                                               <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Image 2 <h6 style="font-size: 14px; color: red;">Size: (500 X 357)</h6></label>
                                                   <div class="col-sm-10">
                                                      <input type="file" class="form-control" name="subcat_image2" id="p_img">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                               <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label"></label>
                                                   <div class="col-sm-10">
                                                     <img class="img-fluid card-img-top" style="height: 400px; width: 600px;" src="{{ asset('Backend/images/solution/'.$data->subcat_image2) }}" alt="Card image cap"><br><br>
                                                   </div>
                                               </div>
                                               <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Image 3 <h6 style="font-size: 14px; color: red;">Size: (500 X 357)</h6></label>
                                                   <div class="col-sm-10">
                                                      <input type="file" class="form-control" name="subcat_image3" id="p_img">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                               <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label"></label>
                                                   <div class="col-sm-10">
                                                     <img class="img-fluid card-img-top" style="height: 400px; width: 600px;" src="{{ asset('Backend/images/solution/'.$data->subcat_image3) }}" alt="Card image cap"><br><br>
                                                   </div>
                                               </div>
                                                <div class="form-group row">
                                               ...
                                               <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                    <textarea class="textarea" rows="3" cols="50" type="text" name="description2" class="form-control" placeholder="Enter Description">{{$data->description2}}</textarea>
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
