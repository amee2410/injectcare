@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Subcategory"=>"Subcategory", "#"=>"Create"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Subcategory.store')}}" method="POST" enctype="multipart/form-data" >
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <select name="solution_slug" class="form-control" id="solution_slug">
                                                      @foreach($solution as $s)
                                                      <option value="{{$s->slug}}">{{$s->solution_name}}</option>
                                                      @endforeach
                                                      </select>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="subcat_name" id="name" placeholder="Name" required>
                                               ...
                                               <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Image 1 <h6 style="font-size: 14px; color: red;">Size: (600 X 800px)</h6></label>
                                                   <div class="col-sm-10">
                                               ...
                                               <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Image 2 <h6 style="font-size: 14px; color: red;">Size: (500 X 357px)</h6></label>
                                                   <div class="col-sm-10">
                                               ...
                                               <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label">Image 3 <h6 style="font-size: 14px; color: red;">Size: (500 X 357px)</h6></label>
                                                   <div class="col-sm-10">
