                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="{{route('Subcategory.create')}}" class="btn btn-out waves-effect waves-light btn-inverse btn-square">Create</a>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>{{$d->subcat_name}}</td>
                                                            <td> 
                                                            <form action="{{route('Subcategory.destroy',$d->id)}}" method="Post">
                                                                <a class="btn btn-primary" href="{{route('Subcategory.edit',$d->id)}}">Edit</a>
                                                                @csrf
                                                                @method('DELETE')
