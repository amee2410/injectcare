@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Clients"=>"Clients", "#"=>"Create"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Clients.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                                @method('PUT') 
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <img class="img-fluid card-img-top" style="height: 150px; width: 150px;" src="{{ asset('Backend/images/client/'.$data->image) }}" alt="Card image cap"><br><br>
                                                   </div>
                                                </div>
