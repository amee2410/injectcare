                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="{{route('Menu.create')}}" class="btn btn-out waves-effect waves-light btn-inverse btn-square">Create</a>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>{{$d->id}}</td>
                                                            <td>{{$d->page_name}}</td>
                                                            <td><img src="{{ asset('/Backend/images/menu/'.$d->banner_image) }}" alt="Image" title="Image" width="500px" height="150px"></td>
                                                            <td> 
                                                            <form action="{{route('Menu.destroy',$d->id)}}" method="Post">
                                                                <a class="btn btn-primary" href="{{route('Menu.edit',$d->id)}}">Edit</a>
                                                                @csrf
                                                                @method('DELETE')
