@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Header_Setting"=>"Header Setting"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Header_Setting.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                                @method('PUT') 
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                         <img class="img-fluid card-img-top" style="height: 100px; width: 100px;" src="{{ asset('Backend/images/header_setting/'.$data->favicon)}}" alt="Card image cap">
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-sm-2 col-form-label"></label>
                                                   <div class="col-sm-10">
                                                         <img class="img-fluid card-img-top" style="height: 100px; width: 300px; background-color: black;" src="{{ asset('Backend/images/header_setting/'.$data->logo)}}" alt="Card image cap"><br><br>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
