@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Certificate"=>"Certificate"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="{{route('Certificate.create')}}" class="btn btn-out waves-effect waves-light btn-inverse btn-square">Create</a>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($data as $d)
                                                            ...
                                                            <form action="{{route('Certificate.destroy',$d->id)}}" method="Post">
                                                                <a class="btn btn-primary" href="{{route('Certificate.edit',$d->id)}}">Edit</a>
                                                                @csrf
                                                                @method('DELETE')
