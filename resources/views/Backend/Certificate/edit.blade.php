@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Certificate"=>"Certificate", "#"=>"Create"]
@endphp
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Certificate.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                               ...
                                               <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <img class="img-fluid card-img-top" style="height: 200px; width: 300px;" src="{{ asset('Backend/images/certificate/'.$data->image) }}" alt="Card image cap"><br><br>
                                                 </div>
                                               </div>
                                                <div class="form-group row">
