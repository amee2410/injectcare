@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Gallery"=>"Gallery"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="{{route('Gallery.create')}}" class="btn btn-out waves-effect waves-light btn-inverse btn-square">Create</a>
                                            ...
                                            <div class="card-block">
                                                <div class="dt-responsive table-responsive">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($data as $d)
                                                            <td>{{$d->id}}</td>
                                                            <td><img src="{{ asset('/Backend/images/gallery/'.$d->image) }}" alt="Image" title="Image" width="250px" height="200px"></td>
                                                            <td> 
                                                            <form action="{{route('Gallery.destroy',$d->id)}}" method="Post">
                                                                <a class="btn btn-primary" href="{{route('Gallery.edit',$d->id)}}">Edit</a>
                                                                @csrf
                                                                @method('DELETE')
