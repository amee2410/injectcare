                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Gallery.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                                @method('PUT') 
                                                @csrf
                                                ...
                                                <img class="img-fluid card-img-top" style="height: 300px; width: 500px;" src="{{ asset('Backend/images/gallery/'.$data->image) }}" alt="Card image cap"><br><br>

                                                <div class="form-group row" hidden="hidden">
                                                   <label class="col-sm-2 col-form-label">Alt Tag</label>
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="alt_tag" value="img" id="p_dec" placeholder="Image Alt Tag" value="{{$data->img_alt_tag}}">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
