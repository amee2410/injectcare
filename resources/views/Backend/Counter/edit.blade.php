                     ...
                     <div class="card-block" style="text-transform: capitalize;">
                        <form id="main" action="{{route('Counter.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <input type="text" class="form-control" name="number" placeholder="Sub-Title" value="{{$data->number}}">
                                 <span class="messages"></span>
                              </div>
                           </div>
                           <div class="form-group row">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <img class="img-fluid card-img-top" style="height: 100px; width: 100px;" src="{{ asset('Backend/images/counter/'.$data->image) }}" alt="Card image cap">
                              </div>
                           </div>
                           <div class="form-group row">
