@php
    ...
    $breadcrumbs = ["/home"=>"Home", "/Counter"=>"Counter"]
@endphp
                                    ...
                                    <div class="col-sm-12">
                                       <div class="card">
                                          ...
                                          <div class="card-block" style="text-transform: capitalize;">
                                             <form id="main" action="{{route('Counter.update',$data->id)}}" method="POST" enctype="multipart/form-data" >
                                                @method('PUT') 
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="count_number" placeholder="Sub-Title" value="{{$data->count_number}}">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                                <div class="form-group row" hidden="hidden">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <input type="text" class="form-control" name="icon_name" placeholder="Sub-Title" value="{{$data->icon_name}}">
                                                      <span class="messages"></span>
                                                   </div>
                                                </div>
                                               <div class="form-group row">
                                               ...
                                               <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-10">
                                                      <img class="img-fluid card-img-top" style="height: 100px; width: 100px;" src="{{ asset('Backend/images/counter/'.$data->icon) }}" alt="Card image cap">
                                                   </div>
                                               </div>
                                                <div class="form-group row">
