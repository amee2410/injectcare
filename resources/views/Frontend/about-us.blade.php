          ...
          <div class="row">
            <div class="col-sm-12 col-lg-12 col-xl-5">
              <div class="image-box-style2">
                <img src="images/about/2.jpg" alt="" class="mb-lg-60 mb-sm-100">
            ...
            <div class="col-sm-12 col-lg-12 col-xl-6">
              <div class="about-style2-current-theme">
                <div class="about-content">
                  <div class="tm-sc-section-title section-title mb-0">
                    <div class="title-wrapper mb-0">
                      <h6 class="text-theme-colored1">About Us</h6>
                      <h2 class="title mt-0">Our Qualified Doctor are Here to Help Your Health</h2>
                      <div class="paragraph mb-40">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                      </div>
                      <div class="row mb-20">
                        <div class="col-sm-6 col-lg-6">
                          <div class="tm-sc-icon-box icon-box icon-left text-left iconbox-centered-in-responsive animate-icon-on-hover animate-icon-rotate-y mb-30">
                            <div class="icon-box-wrapper">
                              <div class="icon-wrapper"> <a class="icon icon-default"> <i class="flaticon-medical-medical51"></i> </a></div>
                              <div class="icon-text">
                                <h5 class="icon-box-title">Qualified Doctor</h5>
                                <div class="content">
                                  <p>Lorem ipsum is simply free dolor sit amet, consecte.</p>
                                </div>
                              </div>
                        ...
                        <div class="col-sm-6 col-lg-6">
                          <div class="tm-sc-icon-box icon-box icon-left text-left iconbox-centered-in-responsive animate-icon-on-hover animate-icon-rotate-y mb-30">
                            <div class="icon-box-wrapper">
                              <div class="icon-wrapper"> <a class="icon icon-default"> <i class="flaticon-medical-science47"></i> </a></div>
                              <div class="icon-text">
                                <h5 class="icon-box-title">Modern Technology</h5>
                                <div class="content">
                                  <p>Lorem ipsum is simply free dolor sit amet, consecte.</p>
                                </div>
                              </div>
                      ...
                      <div class="row mb-20">
                        <div class="col-sm-6 col-lg-6">
                          <div class="tm-sc-icon-box icon-box icon-left text-left iconbox-centered-in-responsive animate-icon-on-hover animate-icon-rotate-y mb-30">
                            <div class="icon-box-wrapper">
                              <div class="icon-wrapper"> <a class="icon icon-default"> <i class="flaticon-medical-handicap2"></i> </a></div>
                              <div class="icon-text">
                                <h5 class="icon-box-title">Trusted Service</h5>
                                <div class="content">
                                  <p>Lorem ipsum is simply free dolor sit amet, consecte.</p>
                                </div>
                              </div>
                        ...
                        <div class="col-sm-6 col-lg-6">
                          <div class="tm-sc-icon-box icon-box icon-left text-left iconbox-centered-in-responsive animate-icon-on-hover animate-icon-rotate-y mb-30">
                            <div class="icon-box-wrapper">
                              <div class="icon-wrapper"> <a class="icon icon-default"> <i class="flaticon-medical-helicopter2"></i> </a></div>
                              <div class="icon-text">
                                <h5 class="icon-box-title">24/7 Emergency</h5>
                                <div class="content">
                                  <p>Lorem ipsum is simply free dolor sit amet, consecte.</p>
                                </div>
                              </div>
            ...
            <div class="col-md-6 col-xl-4">
              <div class="service-box mb-30">
                ...
                <div class="service-details">
                  ...
                  <a href="#" class="btn btn-plain-text-with-arrow"> View Details </a>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-xl-4">
          ...
          <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="widget widget-blog-list clearfix">
              ...
              <div class="tm-widget tm-widget-blog-list ">
                <!-- the loop -->
                <article class="post clearfix mb-30"> <a class="post-thumb" href="#"><img width="100" height="70" src="images/blog/latest-news1.jpg" class="" alt="" /></a>
                  <div class="post-right">
                    <div class="post-date">
