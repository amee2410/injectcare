              ...
              <div class="row header-nav-col-row">
                <div class="col-sm-auto align-self-center">
                  <a class="menuzord-brand site-brand" href="index-mp-layout1.html">
                    ...
                    <img class="logo-default logo-2x retina" src="{{asset('assets/images/logo-wide%402x.png')}}" alt="Logo">
                  </a>
                </div>
                      ...
                      <div class="top-nav-mini-cart-icon-container">
                        <div class="top-nav-mini-cart-icon-contents">
                          <a class="mini-cart-icon" href="shop-cart.html" title="View your shopping cart">
                            <img src="{{asset('assets/images/shopping-cart.png')}}" width="25" alt="cart"><span class="items-count">1</span> 
                            <span class="cart-quick-info">1 item - <span class="amount"><span class="currencySymbol">&pound;</span>18.00</span></span>
                          </a>
                          <div class="dropdown-content">
                            <ul class="cart_list product_list_widget">
                              <li class="mini_cart_item">
                                ...
                                <a href="#"> <img class="attachment-thumbnail" src="{{asset('assets/images/shop/product.jpg')}}" width="300" height="300" alt="" />Beanie</a>
