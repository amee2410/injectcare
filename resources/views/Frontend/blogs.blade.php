...
<!-- Mirrored from kodesolution.com/html/2021/medikx-html/news-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Oct 2023 10:18:02 GMT -->
<head>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 class="title text-white">News Grid</h2>
              <nav role="navigation" class="breadcrumb-trail breadcrumbs">
                <div class="breadcrumbs">
                  ...
                  <span><i class="fa fa-angle-right"></i></span>
                  <span class="trail-item trail-end">News Grid</span>
                </div>
              </nav>
            </div>
          </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
              <div class="blog-style1-current-theme mb-30">
                <article class="post">
                  ...
                  <div class="entry-content">
                    <div class="entry-meta">
                      <h4 class="entry-title mt-0 mb-20"><a href="news-details.html" rel="bookmark">Schoolchildren Unlikely to Transmit</a></h4>
                      <div class="post-excerpt mb-20">
                        <p>Lorem ipsum is simply free text used by new pesnhl note used by new cing elit sed do tempor ut labor.</p>
                      </div>
                      <div class="post-meta">
